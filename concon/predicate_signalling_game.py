...
def get_args(remaining_args=None):
    ...
    group.add_argument('--dump_message', help='dump messages: "last" (default) or "all"', choices=['last', 'all'], nargs='?', const='last', default=None) # TODO Add another option for dumping the language each time the perf is the highest.
