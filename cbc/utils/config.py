...
def get_args():
    ...
    arg_parser.add_argument('--evaluate_language', help='evaluate language instead of training', action='store_true')
    arg_parser.add_argument('--visualize', help='visualize language instead of training', action='store_true')
